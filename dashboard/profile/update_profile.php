...
// معالجة الصورة .. النهاية
    ...
    if (isset($_POST['csrf_token']) && $_POST['csrf_token'] === $_SESSION['csrf_token']) {
        ...
        $userId = $_SESSION['user_id']; // قم بتحديث هذا بناءً على كيفية حفظ معرف المستخدم في الجلسة
...
//        $avatar = $filename;
        ...
        $stmt->bind_param('ssssssssssssssi', $firstName, $lastName, $filename, $phone, $job, $address, $company, $country, $website, $twitter, $facebook, $instagram, $linkedin, $bio, $userId);
